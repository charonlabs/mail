...
def _make_request(task_id: str, sender: str = "supervisor", recipient: str = "analyst") -> MAILMessage:
...
@pytest.mark.asyncio
async def test_submit_and_stream_handles_timeout_and_events(monkeypatch: pytest.MonkeyPatch) -> None:
