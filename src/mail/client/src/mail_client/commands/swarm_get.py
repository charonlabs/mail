...
def cmd_swarm_get(args: Namespace) -> None:
    ...
    try:
        response_obj = SwarmGetResponse.model_validate(response_json)
...
def _print_json(response_obj: SwarmGetResponse) -> None:
    print(response_obj.model_dump_json())


def _print_text(response_obj: SwarmGetResponse) -> None:
