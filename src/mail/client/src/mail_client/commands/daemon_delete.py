...
def cmd_daemon_delete(args: Namespace) -> None:
    ...
    try:
        response_obj = DeleteAdminDaemonResponse.model_validate(response_json)
...
def _print_json(response_obj: DeleteAdminDaemonResponse) -> None:
    print(response_obj.model_dump_json())


def _print_text(response_obj: DeleteAdminDaemonResponse) -> None:
