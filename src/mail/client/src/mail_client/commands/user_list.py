...
def cmd_user_list(args: Namespace) -> None:
    ...
    try:
        response_obj = GetAdminUsersResponse.model_validate(response_json)
...
def _print_json(response_obj: GetAdminUsersResponse) -> None:
    print(response_obj.model_dump_json())


def _print_text(response_obj: GetAdminUsersResponse) -> None:
