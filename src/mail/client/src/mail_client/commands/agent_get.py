...
def cmd_agent_get(args: Namespace) -> None:
    ...
    try:
        response_obj = GetAdminAgentResponse.model_validate(response_json)
...
def _print_json(response_obj: GetAdminAgentResponse) -> None:
    print(response_obj.model_dump_json())


def _print_text(response_obj: GetAdminAgentResponse) -> None:
