...
CATEGORY_KEYWORDS = {
    "billing": [
        "payment", "pay", "charge", "charged", "invoice", "bill", "refund",
        "subscription", "cancel", "price", "pricing", "cost", "credit card",
        "card", "money", "fee", "upgrade", "downgrade", "renew", "renewal",
    ],
    "technical": [
        "bug", "error", "crash", "not working", "broken", "issue", "problem",
        "feature", "slow", "loading", "api", "integration", "code", "export",
        "import", "sync", "download", "upload", "connect", "connection",
    ],
    "account": [
        "login", "password", "reset", "account", "profile", "email", "locked",
        "access", "sign in", "sign up", "register", "2fa", "authentication",
        "security", "verify", "verification", "username", "settings",
    ],
    "general": [
        "question", "help", "support", "information", "info", "how to",
        "what is", "where", "when", "feedback", "suggestion", "thanks",
        "thank you", "appreciate", "curious", "wondering",
    ],
}

PRIORITY_KEYWORDS = {
    "urgent": [
        "urgent", "emergency", "asap", "immediately", "critical", "outage",
        "down", "breach", "hacked", "compromised", "lost all", "cannot access",
        "locked out", "deadline", "now", "right now",
    ],
    "high": [
        "important", "serious", "major", "significant", "blocking", "stuck",
        "cannot", "can't", "unable", "frustrated", "angry", "unacceptable",
        "terrible", "awful", "horrible", "worst",
    ],
    "medium": [
        "issue", "problem", "help", "need", "want", "would like", "please",
        "soon", "when", "how long", "waiting", "expected",
    ],
    "low": [
        "question", "curious", "wondering", "just", "maybe", "might",
        "feedback", "suggestion", "idea", "thanks", "fyi", "minor",
    ],
}
...
async def classify_ticket(args: dict[str, Any]) -> str:
    ...
    if priority == "urgent":
        ...
        reasoning_parts.append("Indicates significant user frustration or blocking issue")
    elif priority == "low":
